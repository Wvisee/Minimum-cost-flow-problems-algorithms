...
G = nx.DiGraph()
G.add_edge(0, 1, weight=5, capacity=1000, flow=0)
G.add_edge(0, 2, weight=6, capacity=1000, flow=0)
G.add_edge(1, 2, weight=4, capacity=1000, flow=0)
G.add_edge(1, 3, weight=12, capacity=1000, flow=0)
G.add_edge(2, 4, weight=3, capacity=1000, flow=0)
G.add_edge(3, 2, weight=8, capacity=1000, flow=0)
G.add_edge(4, 3, weight=9, capacity=1000, flow=0)
G.add_edge(3, 5, weight=5, capacity=1000, flow=0)
G.add_edge(4, 5, weight=1, capacity=1000, flow=0)
G.nodes[0]['b'] = 23
G.nodes[5]['b'] = -23
...
G3 = nx.DiGraph()
G3.add_edge(0, 1, weight=15, capacity=1000, flow=0)
G3.add_edge(0, 2, weight=10, capacity=1000, flow=0)
G3.add_edge(1, 3, weight=10, capacity=1000, flow=0)
G3.add_edge(1, 4, weight=10, capacity=1000, flow=0)
G3.add_edge(1, 5, weight=5, capacity=1000, flow=0)
G3.add_edge(1, 2, weight=5, capacity=1000, flow=0)
G3.add_edge(2, 4, weight=25, capacity=1000, flow=0)
G3.add_edge(2, 5, weight=8, capacity=1000, flow=0)
G3.add_edge(3, 4, weight=30, capacity=1000, flow=0)
G3.add_edge(3, 6, weight=30, capacity=1000, flow=0)
G3.add_edge(4, 6, weight=10, capacity=1000, flow=0)
G3.add_edge(4, 7, weight=10, capacity=1000, flow=0)
G3.add_edge(5, 6, weight=30, capacity=1000, flow=0)
G3.add_edge(5, 7, weight=15, capacity=1000, flow=0)
G3.add_edge(6, 7, weight=30, capacity=1000, flow=0)
G3.nodes[0]['b'] = 100
G3.nodes[6]['b'] = -25
G3.nodes[7]['b'] = -75
...
G4 = nx.DiGraph()
G4.add_edge(0, 1, weight=1, capacity=1000, flow=0)
G4.add_edge(0, 2, weight=5, capacity=1000, flow=0)
G4.add_edge(1, 2, weight=2, capacity=1000, flow=0)
G4.add_edge(1, 3, weight=8, capacity=1000, flow=0)
G4.add_edge(2, 3, weight=3, capacity=1000, flow=0)
G4.add_edge(2, 4, weight=4, capacity=1000, flow=0)
G4.nodes[0]['b'] = 5
G4.nodes[3]['b'] = -3
G4.nodes[4]['b'] = -2
...
#https://www.topcoder.com/thrive/articles/Minimum%20Cost%20Flow%20Part%20Two:%20Algorithms
G5 = nx.DiGraph()
G5.add_edge(0, 2, weight=1, capacity=1000, flow=0)
G5.add_edge(0, 3, weight=2, capacity=1000, flow=0)
G5.add_edge(1, 2, weight=1, capacity=1000, flow=0)
G5.add_edge(1, 3, weight=2, capacity=1000, flow=0)
G5.nodes[0]['b'] = 2
G5.nodes[1]['b'] = 2
G5.nodes[2]['b'] = -2
G5.nodes[3]['b'] = -2
...
G6.add_edge(1, 2, weight=1, capacity=1000, flow=0)
G6.add_edge(1, 3, weight=3, capacity=1000, flow=0)
G6.add_edge(2, 3, weight=1, capacity=1000, flow=0)
G6.nodes[0]['b'] = 6
G6.nodes[3]['b'] = -6
